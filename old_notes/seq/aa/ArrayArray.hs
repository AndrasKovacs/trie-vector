...
unwrap :: ArrayArray -> ArrayArray# 
unwrap (ArrayArray arr) = arr
{-# INLINE unwrap #-}

ret :: MutableArrayArray# s -> State# s -> (# State# s, ArrayArray #)
ret marr s = case unsafeFreezeArrayArray# marr s of
    (# s, arr #) -> (# s, ArrayArray arr #)
{-# INLINE ret #-}
...
-- ThawArray should be preferably given a static length parameter,
